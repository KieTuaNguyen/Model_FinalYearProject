...
def generate_chat_completion(prompt):
    try:
        completion = openai.ChatCompletion.create(
            model=model,
            messages=[
                {"role": "system", "content": 'You are an aspect based sentiment analysis expert in Vietnamese. Find me all aspects and their polarity for the following text. Please response in format: aspect:polarity, aspect: polarity.'},
